...
namespace RenderLibrary.IO
{
    ...
    public class Camera
    {
        ...
        {
            Vector3 direction;
            direction.X = (float)Math.Cos(Mathunctions.ConvertToRadians(yaw)) * (float)Math.Cos(Mathunctions.ConvertToRadians(pitch));
            direction.Y = (float)Math.Sin(Mathunctions.ConvertToRadians(pitch));
            direction.Z = (float)Math.Sin(Mathunctions.ConvertToRadians(yaw)) * (float)Math.Cos(Mathunctions.ConvertToRadians(pitch));
